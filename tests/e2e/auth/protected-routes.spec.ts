...
test.describe('A1 — Home route (/) redirect', () => {
...
test.describe('A4 — Profile page (unauthenticated)', () => {
...
test.describe('A5 — Groups page (unauthenticated)', () => {
...
test.describe('Protected group sub-routes — unauthenticated redirect', () => {
