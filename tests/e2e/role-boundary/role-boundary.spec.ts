...
test.describe('C-02: Non-member → any group sub-route → access denied', () => {
...
test.describe('C-03: Non-superAdmin → /admin redirected to /groups', () => {
  test.beforeEach(async ({ page }) => { await loginAsRole(page, 'friends_member_raghu'); });
...
test.describe('C-04: Member vs Admin — Matches tab visibility', () => {
...
test.describe('C-05: Navbar "Admin" link visibility by role', () => {
  test.beforeEach(async ({ page }) => { await loginAsRole(page, 'friends_member_raghu'); });
...
test.describe('C-08: Member cannot place bet after bettingOpen=false', () => {
  test.beforeEach(async ({ page }) => { await loginAsRole(page, 'friends_member_raghu'); });
