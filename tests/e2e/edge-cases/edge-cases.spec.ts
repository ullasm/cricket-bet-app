...
test.describe('E-01: Empty group dashboard', () => {
...
test.describe('E-02: Betting locked after bettingOpen=false', () => {
  let matchId: string;
...
test.describe('E-03: Draw option gating', () => {
  let matchId: string;
  test.afterEach(async () => { if (matchId) { await deleteTestDocument('matches', matchId); matchId = ''; } });
...
test.describe('E-04: Test format auto-enables draw', () => {
...
test.describe('E-05 / E-06: Stake input', () => {
  let matchId: string;
  test.afterEach(async () => { if (matchId) { await deleteTestDocument('matches', matchId); matchId = ''; } });
...
test.describe('E-07: Remove bet confirmation guard', () => {
  let matchId: string;
  test.afterEach(async () => { if (matchId) { await deleteTestDocument('matches', matchId); matchId = ''; } });
...
test.describe('E-08: Invalid invite code', () => {
...
test.describe('E-09: Group name min-length on Create Group', () => {
...
test.describe('E-10: Profile display name min-length', () => {
...
test.describe('E-11: Delete group type-to-confirm guard', () => {
...
test.describe('E-13: Past matches filter empty state', () => {
...
test.describe('E-14: Member name edit min-length (admin)', () => {
...
test.describe('E-15: Settlements empty state', () => {
...
test.describe('E-16: Already-member join', () => {
...
test.describe('A12 — Bet page /groups/[groupId]/bet/[matchId] [STUB]', () => {
...
test.describe('E-18: Series "ended" badge (superAdmin page)', () => {
...
test.describe('E-19: No upcoming matches in admin search', () => {
...
test.describe('E-20: Manage Bets shows members', () => {
  let matchId: string;
  test.afterEach(async () => { if (matchId) { await deleteTestDocument('matches', matchId); matchId = ''; } });
